...
public class Contact implements Comparable<Contact> {
    ...
    public Contact(String name, String surName, String phoneNumber, int age,
                   double height, double maritalStatus, LocalDateTime createDate) {
        this.name = name;
    ...
    public double getMaritalStatus() {return maritalStatus;}
    public void setMaritalStatus(double maritalStatus) {this.maritalStatus = maritalStatus;}
    ...
    public boolean equals(Object o) {
        ...
        return id == contact.id &&
                ...
                Double.compare(contact.maritalStatus, maritalStatus) == 0 &&
